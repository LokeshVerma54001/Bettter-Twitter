  ...
  return (
    <div className="flex flex-col">
      ...
      <div className=' flex flex-col h-66 '>
        <button className=' self-end bg-white text-black mt-5 mr-5 px-7 py-2 rounded-full'>Edit</button>
        ...
        <p className=' font-light text-sm ml-5 text-gray-500'>@user_name</p>
        <p className=' mt-3 ml-5 '>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ipsam nisi veritatis.</p>
        <p className=' flex items-center text-gray-500 ml-5 mt-1 gap-2'>
          <Calendar /> Joined May 7 2025
        </p>
